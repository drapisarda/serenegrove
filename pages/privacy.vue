<template>
  <section class="section">
    <div class="container">
      ...
      <p>
        We're designing <strong>SereneGrove</strong> making it to have your
        privacy in an high spot. In the current fase of development, we're not
        using tracking technologies. We only rely on your direct feedbacks to test
        and improve our website.
      </p>
      <p>
        We'll update this page if we're going to set cookies or anything that
        may concern your privacy preferences.
      </p>
    </div>
  </section>
  <section class="section">
    <div class="container">
      ...
      <p>Zu den Maßnahmen gehören insbesondere die Sicherung der Vertraulichkeit, Integrität und Verfügbarkeit von Daten
        ...
        Gefährdung der Daten gewährleisten. Ferner berücksichtigen wir den Schutz personenbezogener Daten bereits bei
        der
      ...
      <p>Sofern wir Daten in einem Drittland (d.h., außerhalb der Europäischen Union (EU), des Europäischen
        ...
        oder
        der Offenlegung bzw. Übermittlung von Daten an andere Personen, Stellen oder Unternehmen stattfindet, erfolgt
        dies
